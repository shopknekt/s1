...
ActiveRecord::Schema.define(version: 20161007100745) do
  ...
  add_index "product_stores", ["spree_product_id"], name: "index_product_stores_on_spree_product_id", using: :btree
